...
<div class="min-h-screen bg-[#f7f7f8]">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-xs font-medium tracking-[0.2em] text-gray-400 uppercase mb-2">
                Service Management
            </p>
        ...
        {{-- FORM CARD --}}
        <div class="max-w-5xl bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
            ...
            >
                ...
                <div class="px-7 py-7 space-y-7">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    min="0"
                                    required
                                    class="w-full rounded-xl border border-gray-200 bg-white pl-12 pr-4 py-3 text-sm text-gray-900 outline-none transition focus:border-gray-900 focus:ring-2 focus:ring-gray-900/5"
                                >
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-between mb-2">
                            ...
                            >
                                {{ strlen(old('description', $service->description)) }}/1000
                            </span>
                        ...
                        <textarea
                            ...
                            rows="7"
                            maxlength="1000"
                            placeholder="Tuliskan informasi mengenai layanan..."
                            class="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 outline-none resize-none transition focus:border-gray-900 focus:ring-2 focus:ring-gray-900/5"
                ...
                {{-- FOOTER --}}
                <div class="px-7 py-5 bg-gray-50 border-t border-gray-200">
